...
int main()
{
    ...
    while (1)
    {
        ...
        int pos = calc_360degreePotPosition(adc_0, adc_1);
        int pos2 = calc_360degreePotPosition(adc_2, adc_3);
        
        single_led_in_matrix((pos / 57) + 72, 72, 144);
        single_led_in_matrix((pos2 / 57), 0, 72);
